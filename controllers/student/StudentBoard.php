<?php 
	Class StudentBoard extends CI_Controller{
		...
		public function student_form(){
			...
			$this->form_validation->set_rules('studlname','StudLname','trim|required|min_length[2]|max_length[20]');
			$this->form_validation->set_rules('studfname','StudFname','trim|required|min_length[5]|max_length[10]');
		...
		else
		{
			...
			redirect('student/StudentBoard' , 'refresh');
		}
		}
