      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-red">
            ...
            <a href="<?php echo site_url('subadmin/subdashboard'); ?>" class="small-box-footer">
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-green">
            ...
            <a href="<?php echo site_url('subadmin/subevents'); ?>" class="small-box-footer">
              More info <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-aqua">
            ...
            <a href="<?php echo site_url('student/students'); ?>" class="small-box-footer">
                ...
                <div class="box-tools">
                  <div class="input-group input-group-sm" style="width: 250px;">
                    ...
                    <div class="input-group-btn">
                      <a href="<?php echo site_url('subadmin/searchstudents');?>" class="btn btn-default"><i class="fa fa-search"></i></a>
                    </div>
                  </div>
                </div>
              </div>
