        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div class="box box-primary">
              <div class="box-header with-border">
                <a href="<?php echo site_url('superadmin/Dashboard/create_admin'); ?>" class="btn btn-default btn-sm"><span class="fa fa-plus-square"></span>&nbsp;Create Admin</a></button>
                <div class="box-tools">
                  <div class="input-group input-group-sm" style="width: 250px;">
                    <input type="text" name="table_search" class="form-control pull-right" placeholder="Search Admin">
                    <div class="input-group-btn">
                      <a href="<?php echo site_url('superadmin/Dashboard/search_admin'); ?>" class="btn btn-default"><i class="fa fa-search"></i></a>
                    </div>
                  </div>
                </div>
              </div>
