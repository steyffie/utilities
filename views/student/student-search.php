  ...
  <div class="register-box">
    <div class="box-body">
      <div class="alert alert-danger alert-dismissible">
          ...
          no student id no. found. etc etc
        </div>
    </div>
    <div class="register-logo">
      <a href="<?php echo site_url('student/students'); ?>"><b>CIIT</b>&nbsp;Student Board</a>
    </div>
    <div class="register-box-body">
      <div class="input-group input-group-lg">
        <input type="text" class="form-control" placeholder="Enter Student ID">
        <span class="input-group-btn">
          <button type="button" class="btn btn-default btn-flat"><span class="fa fa-search"></span></button>
        </span>
      </div>
      <br>
      <label>Searches for 2014101010....</label>
